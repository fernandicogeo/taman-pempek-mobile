...
import com.example.tamanpempek.databinding.ActivityDetailBankAdminBinding
...
class DetailBankAdminActivity : AppCompatActivity() {
    private lateinit var binding: ActivityDetailBankAdminBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDetailBankAdminBinding.inflate(layoutInflater)
        ...
        binding.btnEditBank.setOnClickListener {
            val intent = Intent(this, EditBankAdminActivity::class.java).apply {
        ...
        if (isSuccess) {
            AlertDialog.Builder(this).apply {
                ...
                setPositiveButton("Lanjut") { _, _ ->
                    val intent = Intent(this@DetailBankAdminActivity, ProfileAdminActivity::class.java)

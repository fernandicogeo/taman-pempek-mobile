...
import com.example.tamanpempek.databinding.ActivityEditBankAdminBinding
...
class EditBankAdminActivity : AppCompatActivity() {
    private lateinit var binding: ActivityEditBankAdminBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditBankAdminBinding.inflate(layoutInflater)
        ...
        if (isSuccess) {
            AlertDialog.Builder(this).apply {
                ...
                setPositiveButton("Lanjut") { _, _ ->
                    val intent = Intent(this@EditBankAdminActivity, ProfileAdminActivity::class.java)
